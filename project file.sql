...
create table driver(d_id varchar(10) primary key, dfirst_name varchar(20), dlast_name varchar(20), dsalary int, dage int, i_id varchar(10)) ;
create table boatowner(o_id varchar(10) primary key, ofirst_name varchar(20),olast_name varchar(20), ophone varchar(13));
create table management(rent_date date, t_id varchar(10), h_id varchar(10), d_id varchar(10), o_id varchar(10), foreign key(t_id) references tourist(t_id), foreign key(d_id) references driver(d_id), foreign key(h_id) references houseboat(h_id) , foreign key(o_id) references boatowner(o_id) , primary key(rent_date, t_id));	
...
select t_id, rent_date from management;
